...
export default function Home() {
  ...
  return (
   ...
   <div>
        ...
        <div className="svgimage mt-24 sm:ml-6 lg:mr-36 flex justify-center text-center">
                <svg id="logo" width="432" height="93" viewBox="0 0 432 93" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <br></br>
        <div className='mt-80 lg:ml-36 sm:ml-2'>
        <h1 className='homeh1'>
